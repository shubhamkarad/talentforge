...
// Bell button + click-to-open notification feed. Lists the user's recent
// notifications (already fetched realtime via `useNotifications`), shows an
// empty state if none, and offers mark-one / mark-all read.
