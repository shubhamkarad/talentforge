...
// Shared chrome for every auth route — header badge, centered card, footer.
// Keeping it in one place means login/signup/forgot-password stay visually
// consistent as we tweak copy or layout.
